...
public class ScanDataMessageTest extends IncomingMessageTest {
	...
	protected void messageSpecificTest() {
		assertTrue(parsedMessage instanceof ScanDataMessage);
		ScanDataMessage message = (ScanDataMessage) parsedMessage;
